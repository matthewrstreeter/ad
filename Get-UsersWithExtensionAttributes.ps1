...
# This script searches for AD users with any of the extension attributes (extensionAttribute1 through extensionAttribute15) populated in specified OUs and exports the results to a CSV file. Optionally, it can display the results in a GridView.
